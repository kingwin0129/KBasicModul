...
public class ArrayUtils {
    ...
    /**
     * 复制指定的数组并进行处理null
     * 数组中的对象不是克隆的，因此不需要对多维数组进行特殊处理
     * 对于null输入数组，这个方法返回null
     *
     * @param array 浅克隆的数组，可以是null
     * @return 克隆数组
     */
    @Nullable
     ...
     * 对于null输入数组，这个方法返回null
     *
     * @param array 截取的源数组，可以是null
     * @param startIndexInclusive 开始截取的下标
     * @param endIndexExclusive 结束截取的下标
     *
     * @return 截取指定的数组
     */
    ...
    /**
     * <p>复制给定数组并在新数组的末尾添加给定元素</p>
     *
     * <p>新数组包含与输入数组相同的元素，加上最后一个位置的给定元素。新数组的组件类型与输入数组的组件类型相同</p>
     *
     * <p>如果输入数组为<code>null</code>，则返回一个与元素类型相同的新元素数组</p>
     *
     * <pre>
     ...
     * </pre>
     *
     * @param array   realAdd元素的数组，可以是<code>null</code>
