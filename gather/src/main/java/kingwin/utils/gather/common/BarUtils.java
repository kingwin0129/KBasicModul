...
public final class BarUtils {
    ...
    public static int getStatusBarHeight() {
        Resources resources = KUtilsGuide.getApp().getResources();
    ...
    public static void setStatusBarColor(@NonNull final View fakeStatusBar,
                                         @ColorInt final int color) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) return;
        Activity activity = KUtilsGuide.getActivityByContext(fakeStatusBar.getContext());
    ...
    public static int getActionBarHeight() {
        ...
        if (KUtilsGuide.getApp().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, KUtilsGuide.getApp().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = KUtilsGuide.getApp().getSystemService("statusbar");
    ...
    public static int getNavBarHeight() {
        Resources res = KUtilsGuide.getApp().getResources();
    ...
    public static boolean isNavBarVisible(@NonNull final Window window) {
        ...
        if (isVisible) {
            ...
            if (KUtilsGuide.isSamsung()
                    && Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1
                    && Build.VERSION.SDK_INT < Build.VERSION_CODES.Q) {
                try {
                    return Settings.Global.getInt(KUtilsGuide.getApp().getContentResolver(), "navigationbar_hide_bar_enabled") == 0;
    ...
    private static String getResNameById(int id) {
        try {
            return KUtilsGuide.getApp().getResources().getResourceEntryName(id);
        } catch (Exception ignore) {
            return "";
        }
    }
    ...
    public static boolean isSupportNavBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            WindowManager wm = (WindowManager) KUtilsGuide.getApp().getSystemService(Context.WINDOW_SERVICE);
        ...
        boolean menu = ViewConfiguration.get(KUtilsGuide.getApp()).hasPermanentMenuKey();
