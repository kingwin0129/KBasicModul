...
public final class AdaptScreenUtils {
    ...
    /**
     * 适应水平屏幕，并在{@link android.app.Activity#getResources()}中调用它。
     */
    @NonNull
    ...
    /**
     * 适应垂直屏幕，并在{@link android.app.Activity#getResources()}中调用它。
     */
    @NonNull
    ...
    public static int pt2Px(final float ptValue) {
        DisplayMetrics metrics = KUtilsGuide.getApp().getResources().getDisplayMetrics();
    ...
    private static void applyDisplayMetrics(@NonNull final Resources resources, final float newXdpi) {
        ...
        KUtilsGuide.getApp().getResources().getDisplayMetrics().xdpi = newXdpi;
