    ...
    static class Client {
        ...
        Handler mReceiveServeMsgHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                data.setClassLoader(com.blankj.utilcode.util.MessengerUtils.class.getClassLoader());
        ...
        ServiceConnection mConn   = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                msg.getData().setClassLoader(com.blankj.utilcode.util.MessengerUtils.class.getClassLoader());
                msg.replyTo = mClient;
                try {
                    mServer.send(msg);
        ...
        private boolean send2Server(Bundle bundle) {
            ...
            bundle.setClassLoader(com.blankj.utilcode.util.MessengerUtils.class.getClassLoader());
            msg.setData(bundle);
            msg.replyTo = mClient;
            try {
                mServer.send(msg);
        ...
        public int onStartCommand(Intent intent, int flags, int startId) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                Notification notification = UtilsBridge.getNotification(
                        com.blankj.utilcode.util.NotificationUtils.ChannelConfig.DEFAULT_CHANNEL_CONFIG, null
                );
